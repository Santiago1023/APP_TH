...
public class GUIRegistro extends javax.swing.JFrame {
    ...
    GUIDatosPersonales ventanaPersonales;
    GUIDatosLaborales ventanaLaborales;
    Empleado empleado;
    ...
    public GUIRegistro() {
        initComponents();
        ventanaPersonales = new GUIDatosPersonales();
        ventanaLaborales = new GUIDatosLaborales();
    }
    ...
    private void initComponents() {
        ...
        btnDatosPersonales.setText("Ingresar");
        ...
        jLabel2.setText("Sistema de registro Talento Humano");

        jLabel3.setText("Registro de datos personales:");

        jLabel4.setText("Registro de datos laborales:");

        btnDatosLaborales.setText("Ingresar");
    ...
    private void btnDatosPersonalesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDatosPersonalesActionPerformed
        ...
        MainApp.ventanaDatosPersonales.setVisible(true);
    ...
    private void btnDatosLaboralesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDatosLaboralesActionPerformed
        // TODO add your handling code here:
        MainApp.ventanaDatosLaborales.setVisible(true);
        this.setVisible(false);
